...
func _unhandled_input(event: InputEvent) -> void:
	var mouse_cell: Vector2i = TileUtil.cellurize_vector(get_global_mouse_position() + Vector2(32, 32))
...
func _process(delta: float) -> void:
	var new_cell: Vector2i = TileUtil.cellurize_vector(get_global_mouse_position() + Vector2(32, 32))
